...
\begin{example}[the base field $\fK$ as a one-dimensional coordinate space]\label{ex:base-field-space}
...
\begin{example}[function spaces]\label{ex:function-space}
...
\begin{example}[Amer. Math. Monthly., Vol. 94, 1990, p. 60-62]
